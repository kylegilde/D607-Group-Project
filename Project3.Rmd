...
myLocalPassword <- 'pswrd'  # Need to change to your local MySQL password
myLocalUser <- 'root'
myLocalHost <- 'localhost'
myLocalMySQLSchema <- 'cms_Team3' # Need Meaningful name
myLocalTableName <- 'tbl_Team3' # Need Meaningful name
